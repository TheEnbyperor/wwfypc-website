...
## Get Page Content ##
$rsPage = $db->select("SELECT * FROM tbl_pages WHERE pageId='49' LIMIT 1");
...
<div class="rightpanel">
      ...
      <a href="contactus.php"><img src="upload/images/rightpanel/fast_repairs.jpg" alt="" class="right" style="margin-top:25px;"/></a>
