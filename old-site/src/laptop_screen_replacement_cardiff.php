...
mobile_device_detect(true,false,true,true,true,true,true,'http://www.wewillfixyourpc.co.uk/mobile/laptop_screen_replacement_cardiff_mobile.php',false);
						...
						<table border=1 width="550">
						  <tr>
							<td><table width="100%" height="237" cellpadding="0" cellspacing="0">
								<tr>
								  <td colspan="4" align="center" class="Title">We Will Fix Your PC [Laptop Screen Quote] </td>
								</tr>
								<tr>
