...
var menu, titles, submenus, arrows, bypixels,selectedMenu;
...
if (typeof menu!="undefined"){
	for(i=0; i<Math.max(titles.length, submenus.length); i++){
		...
		arrows[i].src = "images/img_minus.gif";
...
if (typeof menu!="undefined"){
	for(i=0; i<Math.max(titles.length, submenus.length); i++){
		...
		arrows[i].src = "images/img_plus.gif";
...
function restore() {
    if(getcookie("menu") != null) {
        ...
        for(var i in hidden) {
            ...
            arrows[hidden[i]].src = "images/img_plus.gif";
        }
    }
}
...
function hidemenu(sm) {
    ...
    if(parseInt(submenus[sm].style.height) <= nr) {
        ...
        arrows[sm].src = "images/img_plus.gif";
...
function showmenu(sm) {
    ...
    if(parseInt(submenus[sm].style.height) > (parseInt(heights[sm])-nr)) {
        ...
        arrows[sm].src = "images/img_minus.gif";
    }
