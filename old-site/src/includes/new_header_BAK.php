...
<div id="mapphonemenu" style="width:685px; height:160px; float:left;">
        	<div id="mapphone" style="width:685px; height:121px;">
                ...
                <div id="phone" style="width:400px; height:114px; float:left;">
                 <h5 style="color:#ff7b00; font-family:Arial, Helvetica, sans-serif;font-size:32px;text-align:center;">Call Now</h5><br/>
