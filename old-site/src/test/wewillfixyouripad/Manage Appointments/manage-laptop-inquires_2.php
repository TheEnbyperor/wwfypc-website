...
if(isset($_GET['DetailMode'])&& $_GET['DetailMode'] == "Delete")
{
	if(isset($_GET['id']) && $_GET['id'] != "")
	{
		...
		$deleteQuery = $objQryBuilder->deleteQry("tbl_laptop_appointments",$whereCondition);
...
<?php 
$searchSql = "SELECT * FROM tbl_laptop_appointments where id !='' order by id DESC";
...
?>
 <tr>
          ...
          <td height="26" class="cptxt"><?php echo $searchRow->name?></td>

          <td height="26" align="left" class="cptxt"><a href="mailto:<?php echo $searchRow->email?>">

            <?php echo $searchRow->email?>

            </a></td>

          <td height="26" align="left" class="cptxt"><?php echo @$searchRow->date?>

            -

            <?php echo @$searchRow->month?></td>

          <td height="26" align="center" class="cptxt"><a href="../Manage Appointments/inquires-details_2.php?id=<?php echo  $searchRow->id?>&height=400&width=600&keepThis=true&TB_iframe=true" class="thickbox">Detail</a></td>

          <td align="center" class="cptxt"><a href="control-panel.php?id=<?php echo $searchRow->id?>&module=<?php echo $module?>&fname=<?php echo $fname?>&DetailMode=Delete" title="Delete" onclick="javascript: return deleteRecordsChk();"><img src="images/delete.gif" border="0"/></a>&nbsp;</td>
