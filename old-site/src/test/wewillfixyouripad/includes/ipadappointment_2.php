...
<div class="rightpanel">
  ...
  <?php
		...
		$rightpanel_image = $db->select("SELECT * FROM tbl_rightpanel_images WHERE status='1' AND id IN (18,19) ORDER BY id ASC LIMIT 0,2");
		if($rightpanel_image)
		...
		####
		?>
  <img src="upload/images/rightpanel/<?=$rightpanel_image[$i]['image']?>" alt="" class="right" style="margin-top:25px;"/>
  <?php } } ?>
</div>
</div>
<?php
