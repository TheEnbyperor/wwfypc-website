...
{
		if(document.getElementById("txtPageTitle").value == "")
		{
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  ?>
   <tr>
	...
	<form name="frmContentsDetail" id="frmContentsDetail" action="edit-contents-draft.php?DetailMode=Edit" method="post" enctype="multipart/form-data" onsubmit="javascript: return FrmValidation();">
