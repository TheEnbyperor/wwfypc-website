...
<form name="frmUserDetail" id="frmUserDetail" action="" method="post" enctype="multipart/form-data">
  ...
  <input name="cus_id" id="cus_id" type="hidden" value="<?= $rsPage["id"] ?>"/>
