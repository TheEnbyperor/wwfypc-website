...
$mtp_id = 1;
$index = "S"; 
include_once("../includes/ipad_header.php");
## Home Page Slider
...
<div class="supportdiv">
  <div class="maindiv">
    ...
    <div class="support3"> <a href="services.php"><img src="../images/support3.jpg" alt=""/></a>
...
<div class="maindiv">
  ...
  <?php
	...
	####
	?>
  <div class="rightpanel"> <a href="appointment.php"><img src="../upload/images/rightpanel/<?=$rightpanel_image['image']?>" alt=""/></a> </div>
</div>
<?php
