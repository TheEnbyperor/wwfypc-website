...
require_once(DOMIT_INCLUDE_PATH . 'xml_domit_shared_2.php');
...
class DOMIT_Node {
	...
	*/
	...
	function forHTML($str, $doPrint = false) {
		...
		require_once(DOMIT_INCLUDE_PATH . 'xml_domit_utilities_2.php');
...
class DOMIT_ChildNodes_Interface extends DOMIT_Node {
	...
	*/
	...
	function &getElementsByAttribute($attrName = 'id', $attrValue = '', 
		...
		require_once(DOMIT_INCLUDE_PATH . 'xml_domit_nodemaps_2.php');
	...
	*/
	...
	function &selectNodes($pattern, $nodeIndex = 0) {
		...
		require_once(DOMIT_INCLUDE_PATH . 'xml_domit_xpath_2.php');
	...
	*/
	...
	function &childNodesAsNodeList() {
		...
		require_once('xml_domit_nodemaps_2.php'); 
...
class DOMIT_Document extends DOMIT_ChildNodes_Interface {
	...
	*/
	...
	function setConnection($host, $path = '/', $port = 80, $timeout = 0, $user = null, $password = null) {
	    ...
	    require_once(DOMIT_INCLUDE_PATH . 'php_http_client_generic_2.php');
	...
	*/
	...
	function setProxyConnection($host, $path = '/', $port = 80, $timeout = 0, $user = null, $password = null) {
	    ...
	    require_once(DOMIT_INCLUDE_PATH . 'php_http_proxy_2.php');
	...
	*/
	...
	function &getElementsByPath($pattern, $nodeIndex = 0) {
		...
		require_once(DOMIT_INCLUDE_PATH . 'xml_domit_getelementsbypath_2.php');
	...
	*/
	...
	function parseXML($xmlText, $useSAXY = true, $preserveCDATA = true, $fireLoadEvent = false) {
        ...
        if ($this->doResolveErrors) {
            ...
            require_once(DOMIT_INCLUDE_PATH . 'xml_domit_doctor_2.php');
	...
	*/
	...
	function getTextFromFile($filename) {
		...
		if ($this->httpConnection != null) {
			...
			require_once(DOMIT_INCLUDE_PATH . 'php_file_utilities_2.php');
...
class DOMIT_Parser {
	...
	*/
	...
	function parseSAXY(&$myXMLDoc, $xmlText, $preserveCDATA = true, $definedEntities) {
		...
		require_once(DOMIT_INCLUDE_PATH . 'xml_saxy_parser_2.php');
	...
	*/
	...
	function endElement(&$parser, $name=null) {
	...
	*/
	...
	function dataElement(&$parser, $data) {
		...
		$this->parseContainer .= $data[0];
		
		echo '<pre>';
		 //print_r( $this->parseContainer );
		 //print_r( $data );
		 //echo $data[0];
		echo '</pre>';
		
		//$data = 'control-panel.php?menuId=2&amp;module=Manage Banner&amp;fname=home-manager.php';
