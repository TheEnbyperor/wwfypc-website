    ...
    <td height="35" colspan="5" align="center" class="cptxt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  ?>
        ...
        <tr>
          ...
          <td height="26" align="center" class="cptxt"><a href="../Manage Appointments/inquires-detail.php?id=<?php echo $searchRow->id?>&height=400&width=600&keepThis=true&TB_iframe=true" class="thickbox">Detail</a></td>
