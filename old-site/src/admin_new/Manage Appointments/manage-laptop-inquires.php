...
?>
 <tr>
          ...
          <td height="26" align="center" class="cptxt"><a href="../Manage Appointments/inquires-details.php?id=<?php echo  $searchRow->id?>&height=400&width=600&keepThis=true&TB_iframe=true" class="thickbox">Detail</a></td>
