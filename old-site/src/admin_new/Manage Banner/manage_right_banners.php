...
<form method="post" name="frmPaging" enctype="multipart/form-data">
  ...
  <input name="ctgid" type="hidden" value="<?php echo $ctg_id?>" />
...

{
    ...
    <td class="cptxt" valign="top" align="center"><form name="frmGallery" id="frmGallery" action="control-panel.php?DetailMode=Edit" method="post" enctype="multipart/form-data" onsubmit="javascript: return FrmValidation('Edit');">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2" style="border-width:2px; border-style:solid; border-color:#F7F7F7;">
          ...
          <tr>
            ...
            <td height="25" align="left" class="cptxt"><strong><?php echo $galleryRS->page?>&nbsp;-&nbsp;<em><?php echo $galleryRS->title?></em></strong></td>
          ...
          <tr>
            ...
            <td width="49%" align="left" valign="top"><input name="chkstatus" type="checkbox" class="cptxt" id="chkstatus" value="1" <?php echo ($galleryRS->status == 1 ? "checked" : "")?> /></td>
  ...
  <tr>
    ...
    <td height="25" colspan="4" align="Left" style="color:#F00" class="cptxt"><?php echo @$displayMessage = (@$displayMessage == "") ? @$_REQUEST['message'] : @$displayMessage;?></td>
  ...
  <tr>
	...
	?>
        ...
        <tr bgcolor="<?php if($counter%2 != 0) echo $bg;?>">
          ...
          <td width="45%" align="left" class="cptxt"><?php echo stripslashes($imagesRow->title)?></td>

          

          <td width="18%" height="25" align="center" class="cptxt"><div align="center"><img src="../upload/images/rightpanel/<?php echo $imagesRow->image?>" alt="N/A"  border="1" width="90"  /></div></td>

          <td align="center" valign="top" class="cptxt" style="vertical-align:middle;"><a href="control-panel.php?id=<?php echo $imagesRow->id?>&amp;module=<?php echo $module?>&amp;fname=<?php echo $fname?>&menuId=<?php echo $menuId?>&amp;DetailMode=Edit&ctgid=<?=$ctg_id?>" title="Edit Record" style="text-decoration:none;color:#0099FF;"><img src="images/edit.gif" border="0"/></a> </td>
