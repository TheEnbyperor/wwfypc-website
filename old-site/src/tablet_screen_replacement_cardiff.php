...
mobile_device_detect(true,false,true,true,true,true,true,'http://www.wewillfixyourpc.co.uk/mobile/tablet_screen_replacement_cardiff_mobile.php',false);
...
## Get Page Content ##
$rsPage = $db->select("SELECT * FROM tbl_pages WHERE pageId='103' LIMIT 1");
	...
	<div class="maindiv">
      ...
      <div class="maindiv" style="height:420px;">
        <div class="fleft" style="width:371px;">
          <div class="fhead">
            <div class="fhead201"> Your Tablet </div>
            <div class="maindiv">
              <div class="name"> Tablet Make </div>
              <div class="formbg2">
                <input id="laptop_maker" name="laptop_maker" type="text" class="forminput"/>
              </div>
            </div>
            <div class="maindiv">
              <div class="name"> Tablet Model &nbsp;&nbsp;&nbsp;&nbsp;<a href="Find_Laptop_Model.html" onClick="return popup(this, 'notes')"><small>- need help?</small></A></div>
              <div class="formbg2">
...
<div class="rightpanel">
  ...
  <?php
      ...
      <a href="http://www.wewillfixyouripad.co.uk/iphone.php"><img src="upload/images/rightpanel/cardiff_iphone_repair.gif" alt="" class="right" style="margin-top:25px;"/></a>
						...
						<table border=1 width="550">
						  <tr>
							<td><table width="100%" height="237" cellpadding="0" cellspacing="0">
								<tr>
								  <td colspan="4" align="center" class="Title">We Will Fix Your PC [Tablet Screen Quote] </td>
								</tr>
								<tr>
                                ...
                                <tr>
								  <td></td>
								  <td class="regular12gray" colspan="4"><span class="Bold12Darkyellow"><b>Tablet Maker:</b></span>&nbsp;&nbsp;&nbsp;&nbsp;'.$quotefrm[0]['laptop_maker'].'</td>
								</tr>
								<tr>
								  <td></td>
