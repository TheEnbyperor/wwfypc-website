...
if(isset($_REQUEST['DetailMode'])&& $_REQUEST['DetailMode'] == "Add")
{
	...
	if (mysql_num_rows($NewsExistresult) == 0)
	{
		if($_FILES['txtphoto']['name'] != "")
		{
			...
			//UploadResizedImage($nfileName, "../upload/images/large/", $tempPath, 500, 450);
			// remove temp path	
...
?>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2" style="border-width:2px; border-style:solid; border-color:#F7F7F7;">
          ...
          <tr>
            ...
            <td height="25" align="left"><input name="txtphoto" type="file" class="textfields" id="txtphoto" value="" size="32" maxlength="100" style="width:256px" />
              ...
              <?=$banner_width?>px x <?=$banner_height?>px)</span></td>
  ...
  <tr>
    <td colspan="4" class="cptxt" valign="top" align="center"><form name="frmNews" id="frmNews" action="control-panel.php?DetailMode=Edit" method="post" enctype="multipart/form-data" onsubmit="javascript: return FrmValidation('Edit');">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2" style="border-width:2px; border-style:solid; border-color:#F7F7F7;">
          <tr>
            <td height="25" colspan="3" align="Left" class="tblHeading">Edit  Slide Image [ <a href="control-panel.php?menuId=4&amp;module=<?=$module?>&fname=<?=$fname?>" style="text-decoration:none;">Add Slide Image</a> ] </td>
            <td height="25"  align="center" class="tblHeading">&nbsp;</td>
          </tr>
          <tr>
            <td width="1%" class="cptxt">&nbsp;</td>
          ...
          <tr>
            <td width="1%" class="cptxt">&nbsp;</td>
            <td width="16%" align="left" valign="top" class="cptxt"> Title:</td>
            <td width="44%" align="left"><input type="text" name="txttitle" id="txttitle" class="textfields" value="<?=stripslashes($newsRS->bnr_title)?>" size="39" maxlength="255" style="width:256px;">
            <span class="manidatory" style="vertical-align:top;">&nbsp;*</span></td>
            <td width="39%" height="25" align="left" class="manidatory" id="tdtitle">&nbsp;</td>
          </tr>
          <tr>
            <td width="1%" class="cptxt">&nbsp;</td>
            <td width="16%" align="left" valign="top" class="cptxt"> Link:</td>
            <td width="44%" align="left"><input type="text" name="txtlink" id="txtlink" class="textfields" value="<?=stripslashes($newsRS->bnr_link)?>" size="39" maxlength="400" style="width:356px;">
            <span class="manidatory" style="vertical-align:top;">&nbsp;</span></td>
            <td width="39%" height="25" align="left" class="manidatory" id="tdtitle">&nbsp;</td>
          </tr>
          <tr style="display:none">
            <td width="1%" class="cptxt">&nbsp;</td>
            <td width="16%" align="left" valign="top" class="cptxt">Short Description:</td>
            <td width="44%" align="left"><textarea type="text" name="txtdescription" id="txtdescription" class="textfields" value="" size="39" maxlength="255" style="width:256px;"><?=stripslashes($newsRS->bnr_description)?>
</textarea>
              <span class="manidatory" style="vertical-align:top">&nbsp;*</span></td>
            <td width="39%" height="25" align="left" class="manidatory" id="tdDescription">&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td height="26" align="left" class="cptxt"><input type="hidden" name="id" id="id" value="<?=$newsRS->bnr_id?>" />
              <input type="hidden" name="preimage" id="preimage" value="<?=$newsRS->bnr_img?>" /></td>
          </tr>
  ...
  <tr>
	...
	?>
        <tr bgcolor="<? if($counter%2 != 0) echo $bg;?>">
          ...
          <td width="10%" align="left" class="cptxt" valign="top"><?=$showStatus?></td>
          <td align="left" valign="top" class="cptxt"><?=substr(strip_tags(stripslashes($newsRow->bnr_title)),0,50)?></td>
          <td align="left" valign="top" class="cptxt"><?=substr(strip_tags(stripslashes($newsRow->bnr_link)),0,50)?></td>
          <td height="25" align="center" valign="top" class="cptxt"><img src="../upload/images/home_banner/<?=$newsRow->bnr_img?>" border="1" width="125" height="69"/></td>
          <td align="center" valign="top" class="cptxt"><a href="control-panel.php?id=<?=$newsRow->bnr_id?>&module=<?=$module?>&fname=<?=$fname?>&DetailMode=Edit" title="Edit Record" style="text-decoration:none;color:#0099FF;"><img src="images/edit.gif" border="0"/></a></td>
          <td width="8%" align="center" valign="top" class="cptxt"><a href="control-panel.php?menuId=4&amp;id=<?=$newsRow->bnr_id?>&module=<?=$module?>&fname=<?=$fname?>&DetailMode=Delete" title="Delete" onclick="javascript: return DeleteRecordsChk();"><img src="images/delete.gif" border="0"/></a>&nbsp;</td>
        </tr>
        <?	
	  	$counter++; 
	  }
