...
define('SERVER_ADDRESS','db777070416.hosting-data.io');
...
define('DATABASE','db777070416');

/**
 * Username to connect the Database.
 */

define('USERNAME','dbo777070416');

/**
 * Password to Connect Database.
 */

define('PASSWORD','39l4mb0urn3');
...
define('WEBSITE_NAME','We Will Fix Your PC');
define('WEBSITE_HOST','');
...
define('WEBSITE_URL','http://www.wewillfixyourpc.co.uk');

/**
 * website slogon.
 */

define('WEBSITE_SLOGAN','We Will Fix Your PC');
...
define('EMAIL_DEFAULT_FROM_NAME','We Will Fix Your PC Administrator');
