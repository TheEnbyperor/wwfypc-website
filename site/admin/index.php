...
include_once ("lib/authentication.class_2.php");
...
<title><?php echo ucfirst(WEBSITE_NAME); ?>-Login</title>

<link href="css/style_login.css" rel="stylesheet" type="text/css" border="0" />
    ...
    <form name="frmUserLogin" id="frmUserLogin" action="index.php" method="post" onSubmit="javascript: return validateLoginform();">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="2">
        ...
        <tr>
          ...
          <td height="40" colspan="2" align="center" style="color:#FF0000; padding-top:15px;"><?php if($controller->CheckIsSet($displayMessage) == 1) echo $displayMessage; ?>
