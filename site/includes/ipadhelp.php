...
<div class="maindiv" style="padding-left:0px;"> <img src="images/fix.jpg" alt="" style="margin-top:31px; float:left;"/> </div>
<div class="maindiv" style="margin:30px 0 0 0;"> <img src="images/check.jpg" alt=""/> <img src="images/call.jpg" alt="" style="margin-left:140px;"/> </div>
</div>
<div class="rightpanel">
	  <?php include_once("includes/contact.php"); ?>
        <?php
		### Getting rightpanel image for this Page
		$rightpanel_image = $db->select("SELECT * FROM tbl_rightpanel_images WHERE status='1' AND id IN (2,3,4,5) ORDER BY id ASC LIMIT 0,4");
		if($rightpanel_image)
