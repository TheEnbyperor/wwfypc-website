...
if(isset($_POST) && (isset($_POST['frmLappointment']) == 22))
{
	...
	else
	{
		...
		$subject="Tablet Screen Quote (Mobile)";
		...
		$values = " Name: '$txtName' <br> Phone Number: '$txtPhone' <br> Email Address: '$txtEmail' <br> Tablet Make: '$laptop_maker'<br> Tablet Model: '$laptop_model' ";
		...
		<div class="box3" style="border-top:1px solid #999; border-left: solid 1px #999999; border-right: 1px solid #999999;">
			...
			<div class="box3">
				<div class="indent" style="background:#FFFFFF;">
                    <ul class="list">
                        <li><a href="services.php">Tablet Screen Quote</a>
                          <blockquote>
              	...
              	<div class="corner-left-bottom">
                	<div class="indent" style="background:#FFFFFF;">
                        ...
                        <input type="hidden" name="frmLappointment" value="22" />
                          ...
                          <label id="lapLbl">Tablet Make & Model</label><br />
