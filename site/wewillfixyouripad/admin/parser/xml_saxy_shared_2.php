...
class SAXY_Parser_Base {
	...
	*/
	...
	function fireStartElementEvent($tagName, $attributes) {
		...
		//print_r(  $this->startElementHandler );
		call_user_func($this->startElementHandler, array(&$this), array(&$tagName), array(&$attributes));
	...
	*/
	...
	function fireEndElementEvent($tagName) {
		...
		call_user_func($this->endElementHandler, array(&$tagName));
	...
	*/
	...
	function fireCharacterDataEvent($data) {
		...
		call_user_func($this->characterDataHandler, array(&$this), array(&$data));
