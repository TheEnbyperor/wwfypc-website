...
if(isset($_REQUEST['DetailMode'])&& $_REQUEST['DetailMode'] == "Add") {
	...
	if( mysqli_num_rows($alreadyExistResult) == 0){
...
################################################# Add product code #########################################################
	...
	<form name="frmUserDetail" id="frmUserDetail" action="control-panel.php?DetailMode=Add&amp;menuId=4&amp;module=<?php echo $module?>&amp;fname=<?php echo $fname?>" method="post" enctype="multipart/form-data" onSubmit="javascript: return FrmValidation('add');">
	...
	<tr>
        ...
        <td colspan="3" align="Left" class="cptxt" height="25"><font color="#FF0000" size="1" face="Arial, Helvetica, sans-serif"><?php echo $displayMessage?></font></td>
...
<?php
	...
	if(isset($_REQUEST['id']) && $_REQUEST['id'] != "") {
		...
		$userDetailRS = mysqli_fetch_object($selectUserDetailResult);
  ...
  ?>
	...
	<tr>
		...
		<form name="frmUserDetail" id="frmUserDetail" action="control-panel.php?DetailMode=Edit&amp;menuId=4&amp;module=<?php echo $module?>&amp;fname=<?php $fname?>" method="post" enctype="multipart/form-data" onSubmit="javascript: return FrmValidation('Edit');">
	  ...
	  <td colspan="4" align="Left" class="tblHeading">EDIT META TAG INFORMATION[ <a href="control-panel.php?menuId=4&amp;module=<?php echo $module?>&amp;fname=<?php echo $fname?>&amp;PrtId=<?php echo @$PrtId?>&amp;Type=<?php echo @urlencode($Type)?> " style="text-decoration:none;">ADD META TAG INFORMATION</a> ]</td> 
    ...
    <tr>
        ...
        <td width="47%" align="left" valign="top"><select name="cbopage" id="cbopage" class="textfields" >
          ...
          <?php echo  LoadMetaPages($userDetailRS->mtp_id) ?>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input type="text" name="mti_title" id="mti_title" class="textfields" value="<?php echo $userDetailRS->mti_title ?>" size="25" maxlength="50" style="width:245px;" />
    ...
    <tr>
        ...
        <td align="left" valign="top"><textarea onBlur="TrimString('mti_desc');" name="mti_desc" rows="4" class="textfields" id="mti_desc"><?php echo $userDetailRS->mti_description ?></textarea>
    ...
    <tr>
      ...
      <td align="left"><textarea onblur="TrimString('mti_keyword');" name="mti_keyword" rows="4" class="textfields" id="mti_keyword"><?php echo $userDetailRS->mti_keywords ?></textarea>
    ...
    <tr>
      ...
      <td align="left"><textarea onblur="TrimString('mti_others');" name="mti_others" rows="4" class="textfields" id="mti_others"><?php echo stripslashes($userDetailRS->mti_others) ?></textarea></td>
    ...
    <tr>
      ...
      <td align="left"><textarea onblur="TrimString('mti_google');" name="mti_google" rows="4" class="textfields" id="mti_google"><?php echo $userDetailRS->mti_google ?></textarea></td>
    ...
    <tr>
      ...
      <td height="26" align="left" class="cptxt"><input name="id" id="id" type="hidden" value="<?php echo $userDetailRS->mtp_id?>"/></td>
...
while($userDetailRS = mysqli_fetch_object($CategoriesResult)) {

?>

<tr bgcolor="<?php echo ($counter%2 != 0 ? $bg : "#f6f6f6")?>">

	

	<td  align="left" valign="top" class="cptxt"><?php echo $userDetailRS->mtp_page?></td>

	<td  align="left" valign="top" class="cptxt"><?php echo substr($userDetailRS->mti_title,0,50)?>...</td>

    <td  align="left" valign="top" class="cptxt"><?php echo substr($userDetailRS->mti_description,0,50)?>...</td>

	<td class="cptxt"><?php echo substr($userDetailRS->mti_keywords,0,50)?>...</td>

    <td height="25" align="center" valign="top" class="cptxt"><a href="control-panel.php?menuId=4&id=<?php echo $userDetailRS->mtp_id?>&module=<?php if(isset($_REQUEST['module']) && $_REQUEST['module'] != "") echo $_REQUEST['module'];?>&fname=<?php if(isset($_REQUEST['fname']) && $_REQUEST['fname'] != "") echo $_REQUEST['fname'];?>" title="Edit Record"><img src="images/edit.gif" border="0"/></a></td>

	<td align="center" valign="top" class="cptxt"><a href="control-panel.php?menuId=4&id=<?php echo $userDetailRS->mtp_id?>&module=<?php if(isset($_REQUEST['module']) && $_REQUEST['module'] != "") echo $_REQUEST['module'];?>&fname=<?php if(isset($_REQUEST['fname']) && $_REQUEST['fname'] != "") echo $_REQUEST['fname'];?>&DetailMode=Delete" title="Delete Record" onClick="javascript: return deleteRecordsChk();"><img src="images/delete.gif" border="0"/></a></td>
...
<form method="post" name="frmPaging" enctype="multipart/form-data">
    ...
    <input name="PrtId" type="hidden" value="<?php echo @$PrtId?>" id="PrtId">
