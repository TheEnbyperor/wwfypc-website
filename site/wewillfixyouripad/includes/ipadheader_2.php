...
<div class="header"> 
		<div id="forlogo" style="width:300px; height:160px; float:left;"><a href="ipadindex.php"><img src="../images/logo.png" alt="" width="296" height="155"/></a></div>
<div id="mapphonemenu" style="width:685px; height:160px; float:left;">
            ...
            <div id="null" style="width:100px; height:114px; float:left;"></div>
                <div id="map" style="width:260px; height:114px; float:left;"><a href="ipadcontactus.php"><img src="../images/map.jpg" alt=""/></a></div>
            ...
            <a href="ipadindex.php" class="menuh<?=$index?>">Home</a> <img src="../images/separator.jpg" class="left"/> <a href="ipadhelp.php" class="menua<?=$help?>">Who We Help              </a><img src="../images/separator.jpg" class="left"/> <a href="ipadchoose.php" class="menua<?=$choose?>">Why Choose Us ?</a> <img src="../images/separator.jpg"              class="left"/> <a    href="ipadservices.php" class="menua<?=$services?>">Services and Prices</a> <img src="../images/separator.jpg" class="left"/> <a href=             "ipadcontactus.php" class="menuc<?=$con    ?>">Contact Us</a> 
            </div>
        </div>
