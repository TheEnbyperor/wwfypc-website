  ...
  ?>
	<tr>
	 ...
	 <input type="hidden" name="db" value="lss">
		<input name="module" id="module" type="hidden" value="<? if(isset($_REQUEST['module']) && $_REQUEST['module'] != "") echo $_REQUEST['module'];?>"/>
		<input name="fname" id="fname" type="hidden" value="<? if(isset($_REQUEST['fname']) && $_REQUEST['fname'] != "") echo $_REQUEST['fname'];?>"/>
		<input type="hidden" name="emailId" id="emailId" value="<?=$userDetailRS->emailId?>"/>		
		<tr>
		...
		<tr>
			...
			<td colspan="2" align="Left" class="cptxt" height="25"><font color="#FF0000" size="1" face="Arial, Helvetica, sans-serif"><?= $displayMessage = ($displayMessage == "") ? $_REQUEST['message'] : $displayMessage;?></font></td> 
		</tr>
		<tr>
			<td width="1%" class="cptxt">&nbsp;</td>
		...
		<tr>
			...
			<td align="left" valign="top">
				<input name="Email" type="text" class="textfields"  id="Email" style="width:250px; vertical-align:top;" value="<?=$userDetailRS->email?>" maxlength="250" onblur="TrimString('Email');" /><span class="manidatory" style="vertical-align:top;">&nbsp;*</span> </td>
			<td height="25" align="left" class="manidatory" id="tdmail">&nbsp;</td>
		</tr>
		<tr>
          <td class="cptxt">&nbsp;</td>
		  <td align="left" valign="top" class="cptxt">Phone No:</td>
		  <td align="left" valign="top"><input name="phon" type="text" class="textfields"  id="phon" style="width:250px; vertical-align:top;" value="<?=$userDetailRS->phoneno?>" maxlength="11"  />
		...
		<tr>
			...
			<td height="26" align="left" class="cptxt"><input type="hidden" name="emailId" id="emailId" value="<?=$userDetailRS->emailId?>" /></td>
		</tr>
		<tr>
...
<tr bgcolor="<? if($counter%2 != 0) echo $bg;?>">
	...
	<td align="center" valign="top" class="cptxt"><div align="left">
	  <?=$userDetailRS->phoneno?>
	</div></td>
	<td height="25" align="center" valign="top" class="cptxt"><a href="control-panel.php?menuId=<?=$menuId?>&amp;emailId=<?=$userDetailRS->emailid?>&amp;module=<? if(isset($_REQUEST['module']) && $_REQUEST['module'] != "") echo $_REQUEST['module'];?>&amp;fname=<? if(isset($_REQUEST['fname']) && $_REQUEST['fname'] != "") echo $_REQUEST['fname'];?>" title="Edit Record"><img src="images/edit.gif" border="0"/></a></td>
<? $counter++; }?></tr>
</table></td>
</tr>
<? } else{?>
