...
## Get Page Content ##
$rsPage = $db->select("SELECT * FROM tbl_pages WHERE pageId='101' LIMIT 1");
...
<div class="rightpanel">
      ...
      <a href="contactus.php"><img src="upload/images/rightpanel/no_vat.jpg" alt="" class="right" style="margin-top:25px;"/></a>
